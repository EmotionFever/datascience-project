...
train: DataFrame = read_csv(f'lab03_knn_and_scaling/ew_data/{file_tag}_train_scaled.csv')
...
test: DataFrame = read_csv(f'lab03_knn_and_scaling/ew_data/{file_tag}_test_scaled.csv')
