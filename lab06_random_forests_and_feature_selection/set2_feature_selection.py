...
savefig(f'lab06_random_forests_and_feature_selection\images\set2\set2_filtered_correlation_analysis_{THRESHOLD}.png')
show()
...
def select_low_variance(data: DataFrame, threshold: float) -> list:
    ...
    savefig('lab06_random_forests_and_feature_selection\images\set2\set_2filtered_variance_analysis.png')
