...
def KNN(file_tag, filename_train, filename_test, s):
    ...
    savefig(f'lab05_decision_trees_and_overfitting\images\set1\{file_tag}_knn_overfit.png')
    plt.show()

    # figure()
    # multiple_line_chart(nvalues, values, title='KNN variants', xlabel='n', ylabel='f1-score', percentage=True)
    # #savefig(f'lab03_knn_and_scaling\images\{file_tag}_knn_study.png')
    # savefig(f'lab05_decision_trees_and_overfitting\images\set1\{file_tag}_knn_study.png')
    # show()
    ...
    # savefig(f'lab05_decision_trees_and_overfitting\images\set1\{file_tag}_knn_best.png')
    # show()
