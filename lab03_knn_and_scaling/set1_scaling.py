...
savefig('lab03_knn_and_scaling/images/set1/boxplots_with_scaling.png')
show()

fig, axs = subplots(1, 1, figsize=(20,10),squeeze=False)
axs[0, 0].set_title('Original data')
data.boxplot(ax=axs[0, 0])
savefig('lab03_knn_and_scaling/images/set1/oryginal_boxplots_with_scaling.png')
show()

fig, axs = subplots(1, 1, figsize=(20,10),squeeze=False)
axs[0, 0].set_title('Z-score normalization')
norm_data_zscore.boxplot(ax=axs[0, 0])
savefig('lab03_knn_and_scaling/images/set1/zscore_boxplots_with_scaling.png')
show()

fig, axs = subplots(1, 1, figsize=(20,10),squeeze=False)
axs[0, 0].set_title('MinMax normalization')
norm_data_minmax.boxplot(ax=axs[0, 0])
savefig('lab03_knn_and_scaling/images/set1/minmax_boxplots_with_scaling.png')
show()


norm_data_zscore.to_csv('lab03_knn_and_scaling/ew_data/set1_scaled.csv', index=False)
