...
savefig('lab01_data_profiling\images\set2\sparsity_study_symbolic_set2_class_variable.png')
show()
...
for i in range(len(numeric_vars)):
    ...
    for j in range(i+1, len(numeric_vars)):
        ...
        axs[i, j-1].scatter(data[var1], data[var2], c = plot_class)
        print(j)
savefig('lab01_data_profiling\images\set2\sparsity_study_numeric_set2_class_variable.png')
show()
