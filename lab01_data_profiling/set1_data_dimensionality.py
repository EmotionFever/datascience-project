...
savefig('lab01_data_profiling/images/records_variables-1.png')
show()
...
savefig('lab01_data_profiling/images/variable_types-1.png')
show()
...
savefig('lab01_data_profiling/images/mv-1.png')
show()