...
savefig('lab01_data_profiling/images/set1/data_dimenstionality_set1_records_variables.png')
show()
...
savefig('lab01_data_profiling/images/set1/data_dimenstionality_set1_variable_types.png')
show()
...
savefig('lab01_data_profiling/images/set1/data_dimenstionality_set1_missing_values.png')
show()